...
team_logos <- list(
  "Arizona Diamondbacks" = "mlb_team_logos/Arizona_Diamondbacks.png",
  "Atlanta Braves" = "mlb_team_logos/Atlanta_Braves.png",
  "Baltimore Orioles" = "mlb_team_logos/Baltimore_Orioles.png",
  "Boston Red Sox" = "mlb_team_logos/Boston_Red_Sox.png",
  "Chicago White Sox" = "mlb_team_logos/Chicago_White_Sox.png",
  "Chicago Cubs" = "mlb_team_logos/Chicago_Cubs.png",
  "Cincinnati Reds" = "mlb_team_logos/Cincinnati_Reds.png",
  "Cleveland Guardians" = "mlb_team_logos/Cleveland_Guardians.png",
  "Colorado Rockies" = "mlb_team_logos/Colorado_Rockies.png",
  "Detroit Tigers" = "mlb_team_logos/Detroit_Tigers.png",
  "Houston Astros" = "mlb_team_logos/Houston_Astros.png",
  "Kansas City Royals" = "mlb_team_logos/Kansas_City_Royals.png",
  "Los Angeles Angels" = "mlb_team_logos/Los_Angeles_Angels.png",
  "Los Angeles Dodgers" = "mlb_team_logos/Los_Angeles_Dodgers.png",
  "Miami Marlins" = "mlb_team_logos/Miami_Marlins.png",
  "Milwaukee Brewers" = "mlb_team_logos/Milwaukee_Brewers.png",
  "Minnesota Twins" = "mlb_team_logos/Minnesota_Twins.png",
  "New York Yankees" = "mlb_team_logos/New_York_Yankees.png",
  "New York Mets" = "mlb_team_logos/New_York_Mets.png",
  "Athletics" = "mlb_team_logos/Athletics.png",
  "Philadelphia Phillies" = "mlb_team_logos/Philadelphia_Phillies.png",
  "Pittsburgh Pirates" = "mlb_team_logos/Pittsburgh_Pirates.png",
  ...
  "Washington Nationals" = "mlb_team_logos/Washington_Nationals.png"
)
